...
# list = [-1, -2, -3, -4, -5, 5, 11, 10, 2, 1]
# sum = 0
# for i in list:
#     if i > 0:
#      sum += i
# print("sum of positive element of list = ", sum)
...
# #prints the missing and additional elements in set2 
